...
begin
  ...
  and coalesce(tenant.is_test_fixture, false) = false
  and coalesce(company.is_test_fixture, false) = false
  and coalesce(site.is_test_fixture, false) = false;
...
comment on function public.read_admin_account_directory() is
  'Returns the server-authorized administrator directory with redacted change summaries and no fixture identities.';
