...
export const ADMIN_OVERVIEW_COPY: Readonly<Record<AppLocale, AdminOverviewCopy>> = Object.freeze({
  en: {
    ...
    actionQr: "QR operations",
    actionQrDescription: "Generate QR assets, track SVG output, intake, activation, and status.",
    actionSites: "Sites",
    ...
    platformLine1: "Dashboard",
    platformLine2: "Platform operations",
    ...
    workspaceLine1: "Dashboard",
    workspaceLine2: "Company operations",
  },
  ko: {
    ...
    actionQr: "QR 운영 관리",
    actionQrDescription: "QR 생성, SVG 출력, 입고, 활성화와 상태 관리를 확인합니다.",
    actionSites: "사이트",
