export const ko = {
  ...
  "admin.qr.batch.request.description":
    "승인된 Site 디자인으로 최대 10,000개의 샘플 검토·대량 생성 Batch를 요청합니다.",
  ...
  "admin.qr.securityNote": "Tenant/Site scope · RLS · maker-checker · 원자적 감사",
  ...
  "landing.eyebrow": "QR로 시작하는 익명 차량 커뮤니케이션",
  ...
  "landing.journey.reply.description": "차주의 원터치 답장이 호출자의 임시 대화방에 도착합니다.",
  ...
  "landing.privacy.description":
    "호출자와 차주의 전화번호를 서로에게 보여 주지 않고, QR·요청·답장은 목적 제한형 Contact Session 안에서만 연결합니다.",
  ...
  "onboarding.hero.description":
    "Taptolk는 호출자, 차주, 고객 관리자, 플랫폼 어드민의 시작 경로를 분리합니다. 아래에서 지금 상황에 맞는 입구를 선택하세요.",
  ...
  "onboarding.token.description":
    "호출자 연락과 신규 차주 활성화는 발급된 QR 또는 안전한 전용 링크에서만 시작됩니다. 이 페이지는 임의의 차량이나 토큰을 입력받지 않습니다.",
...
export const en = {
  ...
  "admin.qr.batch.request.description":
    "Request up to 10,000 items for sample review and bulk generation with an approved Site design.",
  ...
  "admin.qr.securityNote": "Tenant/Site scope · RLS · maker-checker · atomic audit",
  ...
  "landing.eyebrow": "Anonymous vehicle communication initiated by QR",
  ...
  "landing.privacy.description":
    "Caller and owner phone numbers remain hidden from each other. The QR, request, and reply connect only inside a purpose-limited Contact Session.",
  "landing.privacy.eyebrow": "Privacy by Design",
  ...
  "onboarding.token.description":
    "Caller contact and new-owner activation begin only from an issued QR or protected dedicated link. This page never accepts an arbitrary vehicle or token.",
