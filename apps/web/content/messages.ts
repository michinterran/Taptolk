export const ko = {
  ...
  "admin.qr.batch.request.description":
    "승인된 Site 디자인으로 1–100개 범위의 샘플 검토 Batch를 요청합니다.",
  ...
  "admin.qr.design.config": "디자인 설정 JSON",
  ...
  "admin.qr.sample.attach.description": "렌더 결과의 위치, 체크섬과 품질검사 결과를 연결합니다.",
...
export const en = {
  ...
  "admin.qr.batch.request.description":
    "Request a 1–100 item sample-review Batch with an approved Site design.",
  ...
  "admin.qr.design.config": "Design configuration JSON",
  ...
  "admin.qr.sample.attach.description":
    "Connect renderer output location, checksum, and quality results.",
