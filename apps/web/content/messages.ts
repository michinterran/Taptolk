export const ko = {
  ...
  "admin.qr.board.lane.distribution": "배부",
  "admin.qr.board.lane.distribution.hint": "현장 입고 후 차량 배부",
  "admin.qr.board.lane.generation": "생성",
  "admin.qr.board.lane.generation.hint": "디자인·샘플·승인·생성",
  "admin.qr.board.lane.print": "인쇄",
  "admin.qr.board.lane.print.hint": "출력 파일·인쇄 의뢰",
  "admin.qr.board.lane.shipping": "배송",
  "admin.qr.board.lane.shipping.hint": "발송·현장 도착",
  "admin.qr.board.laneEmpty": "이 국면에 있는 제작 묶음이 없습니다.",
  "admin.qr.board.outcomes": "종료된 제작 묶음",
  "admin.qr.board.outcomesEmpty": "취소되거나 실패한 제작 묶음이 없습니다.",
  "admin.qr.board.unplaced": "국면을 판정할 수 없는 상태",
...
export const en = {
  ...
  "admin.qr.board.lane.distribution": "Distribution",
  "admin.qr.board.lane.distribution.hint": "Handed out on site after intake",
  "admin.qr.board.lane.generation": "Generation",
  "admin.qr.board.lane.generation.hint": "Design, sample, approval, generation",
  "admin.qr.board.lane.print": "Print",
  "admin.qr.board.lane.print.hint": "Print file and print order",
  "admin.qr.board.lane.shipping": "Shipping",
  "admin.qr.board.lane.shipping.hint": "Dispatched and delivered on site",
  "admin.qr.board.laneEmpty": "No production lot is in this phase.",
  "admin.qr.board.outcomes": "Closed production lots",
  "admin.qr.board.outcomesEmpty": "No production lot was cancelled or failed.",
  "admin.qr.board.unplaced": "Status with no known phase",
